...
import com.roovies.concertreservation.users.infra.adapter.in.web.request.CreateUserRequest;
import com.roovies.concertreservation.users.infra.adapter.in.web.request.DeleteUserRequest;
import com.roovies.concertreservation.users.infra.adapter.in.web.request.UpdatePasswordRequest;
import com.roovies.concertreservation.users.infra.adapter.in.web.request.UpdateUserRequest;
import com.roovies.concertreservation.users.infra.adapter.in.web.response.GetUserResponse;
import com.roovies.concertreservation.users.infra.adapter.in.web.response.UpdateUserResponse;
...
public class UserController {
    ...
    @GetMapping("/me")
    public ResponseEntity<GetUserResponse> getMyInformation(@AuthenticationPrincipal UserDetails userDetails) { // TODO: Custom User Details 구현 필요
        return ResponseEntity.status(HttpStatus.OK).body(GetUserResponse.builder()
